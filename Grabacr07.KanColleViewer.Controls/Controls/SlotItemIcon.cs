...
namespace Grabacr07.KanColleViewer.Controls
{
	...
	public class SlotItemIcon : Control
	{
		...
		#region LargeMode 依存関係プロパティ

		public Orientation Mode
		{
			get { return (Orientation)this.GetValue(ModeProperty); }
			set { this.SetValue(ModeProperty, value); }
		}
		public static readonly DependencyProperty ModeProperty =
			DependencyProperty.Register("Mode", typeof(Orientation), typeof(SlotItemIcon), new UIPropertyMetadata(Orientation.Vertical));
