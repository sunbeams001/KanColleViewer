...
namespace Grabacr07.KanColleWrapper
{
	partial class KanColleProxy
	{
		...
		{
			get { return this.ApiSessionSource.Where(x => x.Request.PathAndQuery == "/kcsapi/api_req_battle_midnight/battle"); }
		}
		...
		{
			get { return this.ApiSessionSource.Where(x => x.Request.PathAndQuery == "/kcsapi/api_req_practice/battle"); }
		}
		...
		{
			get { return this.ApiSessionSource.Where(x => x.Request.PathAndQuery == "/kcsapi/api_req_practice/battle_result"); }
		}
